...
pub fn fn0(mut _1: bool,mut _2: char,mut _3: u64,mut _4: i8,mut _5: u8,mut _6: u16) -> isize {
mir! {
type RET = isize;
let _7: Adt45;
let _8: isize;
...
_5 = 245589543580181343928046133386874714064_u128 as u8;
_4 = (-122_i8) - 99_i8;
_1 = true;
_6 = 34360_u16;
_6 = 107728443990718432784468081270929550582_u128 as u16;
_6 = _4 as u16;
RET = -(-9223372036854775808_isize);
_4 = 4_usize as i8;
_7.fld0 = 434027579823075489_u64 ^ 9521618551199364640_u64;
_1 = _6 == _6;
_4 = !95_i8;
_2 = '\u{80554}';
_7.fld0 = !8769074516727554546_u64;
_2 = '\u{ad899}';
_4 = !(-17_i8);
RET = 9223372036854775807_isize;
_1 = _4 != _4;
_7 = Adt45 { fld0: 2874581624261886758_u64 };
_4 = -(-94_i8);
_7.fld0 = (-7711524561470221398_i64) as u64;
_7 = Adt45 { fld0: 12419196790637705866_u64 };
_9 = !_6;
_7 = Adt45 { fld0: 9870273676285585653_u64 };
_10 = RET | RET;
_8 = 962897447_u32 as isize;
_3 = !_7.fld0;
match RET {
0 => bb1,
1 => bb2,
...
bb8 = {
RET = (-81634302587517091476288400038682846853_i128) as isize;
_5 = 2_usize as u8;
_8 = 7_usize as isize;
_5 = 85_u8;
RET = _10;
...
_7.fld0 = _3;
_10 = RET - RET;
_4 = 167612154817017099634783472402769826064_i128 as i8;
_7 = Adt45 { fld0: _3 };
_7 = Adt45 { fld0: _3 };
RET = -_10;
RET = !_8;
RET = !_10;
RET = (-31184379796165193443365103812483880391_i128) as isize;
_6 = _9;
_2 = '\u{f2d3f}';
match _5 {
0 => bb1,
...
bb11 = {
_6 = 99574433600607442817510640372257898229_i128 as u16;
Goto(bb12)
}
bb12 = {
_5 = 244_u8;
...
RET = !_10;
_1 = false;
_7.fld0 = 160857349629676469778015953478845328019_i128 as u64;
_5 = 65_u8 << _10;
_2 = '\u{6f99f}';
RET = _10 * _10;
RET = -_8;
...
bb15 = {
Call(_17 = dump_var(0_usize, 1_usize, Move(_1), 3_usize, Move(_3), 2_usize, Move(_2), 8_usize, Move(_8)), ReturnTo(bb16), UnwindUnreachable())
}
bb16 = {
Call(_17 = dump_var(0_usize, 14_usize, Move(_14), 18_usize, _18, 18_usize, _18, 18_usize, _18), ReturnTo(bb17), UnwindUnreachable())
}
bb17 = {
Return()
}
...
pub fn main() {
                fn0(std::hint::black_box(true), std::hint::black_box('\u{d7edc}'), std::hint::black_box(13469514531896155033_u64), std::hint::black_box(119_i8), std::hint::black_box(80_u8), std::hint::black_box(44879_u16));
...
Variant1{
fld0: [u16; 5],
fld1: (u64, (i16, i128, i128, *const bool, i16, bool, char)),
fld2: [i64; 2],
fld3: i32,
...
fld2: u32,
fld3: (i16, isize),
fld4: (isize, [u16; 2], [usize; 4]),
fld5: [u16; 2],
fld6: (char, ([i128; 7], i16, u64), i128),

},
Variant3{
fld0: [i128; 7],
fld1: (i16, i128, i128, *const bool, i16, bool, char),
fld2: Adt43,
...
Variant0{
fld0: isize,
fld1: ([i128; 7], i8, isize),

},
Variant1{
fld0: Adt41,
fld1: [u16; 6],
fld2: ([i128; 7], i8, isize),
fld3: Adt45,
fld4: (u32, u16),
fld5: i32,
fld6: *mut f64,
...
fld2: u64,
fld3: (i16, isize),
fld4: (i16, i128, i128, *const bool, i16, bool, char),
fld5: *const [usize; 4],
fld6: ([i128; 7], i16, u64),
fld7: [u16; 2],
...
fld1: *mut f64,
fld2: isize,
fld3: (i16, i128, i128, *const bool, i16, bool, char),
fld4: i16,
...
fld1: [i128; 7],
fld2: Adt45,
fld3: (isize, [u16; 2], [usize; 4]),
fld4: (u64, (i16, i128, i128, *const bool, i16, bool, char)),
}
