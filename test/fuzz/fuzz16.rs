...
pub fn fn3(
    ...
    _4.0 = RET as usize;
    Call(invalid = fn4(false, 2.0, 3, false, _6, _4.1, _7, _8, _3), ReturnTo(bb4), UnwindUnreachable())
    }
    bb4 = {
...
pub fn fn4(
    ...
    _7 = _9 * _9;
    _13 = [false,true,true,false,false];
...
pub fn main() {
    fn0(
        ...
        std::hint::black_box('\u{3d022}'),
        std::hint::black_box((-9223372036854775808_isize)),
        std::hint::black_box(36_i8),
        std::hint::black_box(17258_i16),
        std::hint::black_box(781316102_i32),
        std::hint::black_box((-8230647398923213200_i64)),
        std::hint::black_box(119645051273590128198100497033719736472_i128),
        std::hint::black_box(5_usize),
        std::hint::black_box(152_u8),
        std::hint::black_box(65058_u16),
        std::hint::black_box(2049202978_u32),
        std::hint::black_box(6597727627350748864_u64),
        std::hint::black_box(226674313752560783149186538797687629187_u128),
    );
}
impl PrintFDebug for Adt44 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt44::".as_ptr() as *const c_char) };
        match self {
...
impl PrintFDebug for Adt45 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt45::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 { fld0 } => {
                unsafe { printf(c"Variant0{".as_ptr()) };
                unsafe { printf(c"fld0:".as_ptr()) };
...
impl PrintFDebug for Adt46 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt46::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
pub enum Adt48 {
    ...
    Variant2 {
        ...
        fld2: (i8, [i64; 7]),
        fld3: (
            (usize, bool, *const i128),
            i8,
            (bool, *const i128, u128, *const i128, u8),
            (usize, bool, *const i128),
            [u32; 7],
        ),
        fld4: u32,
...
impl PrintFDebug for Adt50 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt50::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 { fld0 } => {
                unsafe { printf(c"Variant0{".as_ptr()) };
                unsafe { printf(c"fld0:".as_ptr()) };
...
impl PrintFDebug for Adt51 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt51::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt52 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt52::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt53 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt53::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 { fld0 } => {
                unsafe { printf(c"Variant0{".as_ptr()) };
                unsafe { printf(c"fld0:".as_ptr()) };
...
impl PrintFDebug for Adt54 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt54::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt55 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt55::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 { fld0, fld1, fld2 } => {
                unsafe { printf(c"Variant0{".as_ptr()) };
                unsafe { printf(c"fld0:".as_ptr()) };
...
impl PrintFDebug for Adt56 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt56::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt57 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt57::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt58 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt58::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt59 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt59::".as_ptr() as *const c_char) };
        match self {
            Self::Variant0 {
                fld0,
                fld1,
...
impl PrintFDebug for Adt60 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt60::".as_ptr() as *const c_char) };
        match self {
