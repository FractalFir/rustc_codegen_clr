...
pub fn fn0(mut _1: bool,mut _2: char,mut _3: isize,mut _4: i8,mut _5: u64,mut _6: u128,mut _7: i64,mut _8: u16,mut _9: usize,mut _10: u8) -> ((f32, char, u8), [i8; 8], i32) {
mir! {
type RET = ((f32, char, u8), [i8; 8], i32);
let _11: (f32, char, u8);
let _12: [isize; 3];
let _13: *mut u128;
let _14: char;
...
_1 = !true;
_10 = _1 as u8;
_5 = 7948617201146394495_u64;
RET.0.1 = '\u{1f890}';
_3 = 4022257521902028582_i64 as isize;
_11.2 = _10 | _10;
_7 = 1035716649_i32 as i64;
_5 = (-178402369_i32) as u64;
_3 = (-9223372036854775808_isize) >> _11.2;
RET.1 = [18_i8,61_i8,(-43_i8),66_i8,1_i8,(-43_i8),(-11_i8),(-29_i8)];
_10 = _11.2 ^ _11.2;
_4 = (-2_i8) - 109_i8;
_9 = !4_usize;
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
RET.0.2 = _10 + _10;
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
RET.0.0 = 1203826212_u32 as f32;
_1 = !false;
_15 = -RET.0.0;
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
RET.0 = (_15, '\u{30014}', _10);
Goto(bb1)
}
bb1 = {
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
...
_10 = _11.2;
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
_15 = 287664346386815379746199721721851802786_u128 as f32;
_6 = 2872059238_u32 as u128;
_11 = RET.0;
RET.2 = 1305451064_i32;
_2 = _14;
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
_8 = !59655_u16;
Goto(bb2)
...
_20 = [RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2];
_6 = 27631634343372166877826064858973426050_u128 ^ 172380673805735030952158304964029352881_u128;
_15 = _3 as f32;
_22 = 2407_i16;
_1 = true;
_11.0 = RET.0.0;
_9 = 15519199435067129662_usize - 5_usize;
_7 = (-8665226890964419475_i64);
_7 = 8544221221469750144_i64 + 1079234715063404759_i64;
_12 = [_3,_3,_3];
match RET.2 {
0 => bb1,
1 => bb3,
...
bb6 = {
_8 = 38066_u16 + 62923_u16;
RET.0.0 = _11.0;
_6 = !140168480052079919340141429672321770240_u128;
_20 = [RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2];
RET.1 = [_4,_4,_4,_4,_4,_4,_4,_4];
_1 = !false;
_11.2 = _22 as u8;
_23 = [_2,_14,RET.0.1,_14,_2,_2];
RET.0 = (_15, _11.1, _10);
_23 = [_2,_11.1,_2,RET.0.1,_11.1,_2];
RET.0.1 = _2;
_13 = core::ptr::addr_of_mut!(_6);
RET.2 = 536407338_i32 ^ (-2000815986_i32);
_28 = _4 as i64;
_1 = !true;
_22 = 2385089052_u32 as i16;
_20 = [RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2];
...
bb7 = {
_27 = !_1;
(*_13) = !47293674970640120635559768741658498930_u128;
_8 = _14 as u16;
_21 = [_8,_8,_8,_8,_8];
RET.0.0 = (*_13) as f32;
_11.0 = RET.0.0;
...
_20 = [RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2,RET.2];
_19 = _10;
(*_13) = !195829500364937704588574884479048805337_u128;
RET.0.2 = (*_13) as u8;
_17 = RET.0.0 * _11.0;
RET.0.0 = _15;
_12 = [_3,_3,_3];
...
RET.0.2 = _10 >> (*_13);
_19 = RET.0.2 ^ _10;
_23 = [_2,_14,RET.0.1,RET.0.1,RET.0.1,_14];
match _4 {
0 => bb1,
1 => bb2,
2 => bb6,
...
_3 = 103_isize;
_1 = !_27;
_23 = [_14,RET.0.1,_11.1,RET.0.1,RET.0.1,RET.0.1];
_6 = 41269414747688387659072367964794527717_u128 | 47449651489177858574802717508302292571_u128;
_26 = _1 as isize;
_1 = _27 ^ _27;
_6 = _5 as u128;
_11.0 = _22 as f32;
_17 = -RET.0.0;
_23 = [RET.0.1,_14,_2,_14,_11.1,RET.0.1];
_17 = _11.0 + _15;
_14 = RET.0.1;
_17 = RET.0.0;
RET.0.2 = _19 >> (*_13);
_23 = [_11.1,_2,_14,_2,_14,_14];
RET.0.1 = _14;
RET.0.2 = _11.2;
_11.1 = _14;
Goto(bb14)
...
RET.0 = (_15, _2, _10);
_11.0 = _19 as f32;
(*_13) = 118242913844198720958698941677440149980_u128 * 322362650593433193532938822566256602236_u128;
Goto(bb15)
}
bb15 = {
Call(_34 = dump_var(0_usize, 3_usize, Move(_3), 12_usize, Move(_12), 7_usize, Move(_7), 6_usize, Move(_6)), ReturnTo(bb16), UnwindUnreachable())
}
bb16 = {
Call(_34 = dump_var(0_usize, 10_usize, Move(_10), 5_usize, Move(_5), 26_usize, Move(_26), 28_usize, Move(_28)), ReturnTo(bb17), UnwindUnreachable())
}
bb17 = {
Call(_34 = dump_var(0_usize, 19_usize, Move(_19), 23_usize, Move(_23), 35_usize, _35, 35_usize, _35), ReturnTo(bb18), UnwindUnreachable())
}
bb18 = {
Return()
}
...
pub fn main() {
                fn0(std::hint::black_box(false), std::hint::black_box('\u{5e3c0}'), std::hint::black_box((-9223372036854775808_isize)), std::hint::black_box(41_i8), std::hint::black_box(4037611797060830668_u64), std::hint::black_box(315095765284749279453015279552143217548_u128), std::hint::black_box((-6110586544482293245_i64)), std::hint::black_box(10572_u16), std::hint::black_box(15483166812968615843_usize), std::hint::black_box(39_u8));
