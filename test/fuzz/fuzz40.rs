...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn1(mut _1: i128,mut _2: u128,mut _3: u8,mut _4: char,mut _5: u8,mut _6: isize,mut _7: u32,mut _8: i64,mut _9: u8,mut _10: i128,mut _11: char,mut _12: char,mut _13: u16,mut _14: i64,mut _15: i128) -> u64 {
mir! {
type RET = u64;
let _16: char;
let _17: [u32; 1];
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn2(mut _1: i64,mut _2: char,mut _3: u8,mut _4: u16,mut _5: char,mut _6: u8,mut _7: i128,mut _8: i128,mut _9: char) -> i128 {
mir! {
type RET = i128;
let _10: f32;
let _11: *const f32;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn3(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: char,mut _5: i128,mut _6: i128,mut _7: char) -> char {
mir! {
type RET = char;
let _8: f64;
let _9: Adt55;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn5(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: i128,mut _5: i128,mut _6: i128,mut _7: i128,mut _8: [i32; 2],mut _9: i128,mut _10: i128) -> char {
mir! {
type RET = char;
let _11: isize;
let _12: Adt48;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn6(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: i128,mut _5: i128,mut _6: i128) -> [i32; 2] {
mir! {
type RET = [i32; 2];
let _7: [u16; 6];
let _8: [u32; 6];
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn8(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: [i16; 6],mut _5: i128,mut _6: i128,mut _7: i128,mut _8: i128,mut _9: i128,mut _10: i128) -> *mut (i8, isize, [i32; 2]) {
mir! {
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn10(mut _1: bool,mut _2: bool,mut _3: bool,mut _4: bool,mut _5: bool,mut _6: bool,mut _7: bool,mut _8: bool,mut _9: bool,mut _10: bool,mut _11: bool,mut _12: bool,mut _13: bool,mut _14: bool) -> i128 {
mir! {
type RET = i128;
let _15: [i32; 2];
let _16: [i8; 4];
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn11(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: i128,mut _5: [u16; 6],mut _6: i128,mut _7: i128,mut _8: i128) -> [i16; 6] {
mir! {
type RET = [i16; 6];
let _9: isize;
let _10: [i32; 2];
...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn12(mut _1: i128,mut _2: i128,mut _3: i128,mut _4: i128,mut _5: i128,mut _6: i128,mut _7: i128,mut _8: i128) -> i128 {
mir! {
type RET = i128;
let _9: (usize, i16);
let _10: isize;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn13(mut _1: i128,mut _2: *const f32,mut _3: i128,mut _4: f32,mut _5: i128,mut _6: f64,mut _7: i128,mut _8: i128,mut _9: *const f32,mut _10: (u64,),mut _11: i128,mut _12: f32) -> [i32; 2] {
mir! {
type RET = [i32; 2];
let _13: Adt45;
let _14: Adt53;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn15(mut _1: [i8; 4],mut _2: *const f32,mut _3: [usize; 3],mut _4: [usize; 3],mut _5: i16,mut _6: [usize; 3],mut _7: [usize; 3],mut _8: bool,mut _9: [i8; 4],mut _10: *const f32,mut _11: [i8; 4],mut _12: [i8; 4],mut _13: [usize; 3],mut _14: bool) -> f32 {
mir! {
type RET = f32;
let _15: isize;
let _16: Adt49;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn18(mut _1: [u32; 6],mut _2: [u32; 6],mut _3: [u32; 6],mut _4: [u32; 6],mut _5: char,mut _6: (u64,),mut _7: [u32; 6],mut _8: [usize; 3],mut _9: (u64,),mut _10: [i32; 2]) -> i8 {
mir! {
type RET = i8;
let _11: f32;
let _12: u128;
...
#[custom_mir(dialect = "runtime", phase = "initial")]
fn fn19(mut _1: isize,mut _2: [u16; 6],mut _3: u32,mut _4: [u16; 6],mut _5: [u16; 6],mut _6: f32,mut _7: i32,mut _8: u64,mut _9: isize,mut _10: f32,mut _11: (u64,),mut _12: u32,mut _13: [usize; 3],mut _14: f32) -> Adt51 {
mir! {
type RET = Adt51;
let _15: i128;
let _16: isize;
...
pub fn main() {
                fn0(std::hint::black_box(true), std::hint::black_box('\u{be289}'), std::hint::black_box(9223372036854775807_isize), std::hint::black_box(24_i8), std::hint::black_box(13914_i16), std::hint::black_box((-1963126301_i32)), std::hint::black_box((-3407012583659461294_i64)), std::hint::black_box((-50464232047376664440829169328549646287_i128)), std::hint::black_box(0_usize), std::hint::black_box(101_u8), std::hint::black_box(38232_u16), std::hint::black_box(2904913413_u32), std::hint::black_box(17095853152942221982_u64), std::hint::black_box(291092824882136121120749181999185014710_u128));
...
fld0: [u32; 1],
fld1: Adt46,
fld2: ([u32; 6], (i8, isize, [i32; 2]), *const f32, [i16; 6], [u64; 2]),
fld3: i8,
fld4: [u64; 2],
fld5: [u32; 6],
...
fld2: isize,
fld3: i64,
fld4: ([u32; 6], (i8, isize, [i32; 2]), *const f32, [i16; 6], [u64; 2]),
...
fld1: ([u32; 6], (i8, isize, [i32; 2]), *const f32, [i16; 6], [u64; 2]),
fld2: [char; 7],
fld3: u128,
fld4: Adt50,
