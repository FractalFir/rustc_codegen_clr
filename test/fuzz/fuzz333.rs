...
fn fn14(
    mut _1: char,
    mut _2: (i16, u64, i16, u64, bool, char),
    mut _3: [u8; 7],
    mut _4: (i16, u64, i16, u64, bool, char),
    mut _5: char,
    mut _6: [u8; 7],
    mut _7: u64,
) -> [u8; 7] {
...
fn fn15(
    ...
    mut _13: i16,
    mut _14: u64,
    mut _15: (i16, u64, i16, u64, bool, char),
    mut _16: Adt43,
) -> i32 {
    mir! {
    type RET = i32;
...
pub fn fn17(
    ...
    mut _4: [u8; 7],
    mut _5: u64,
    mut _6: (i16, u64, i16, u64, bool, char),
    mut _7: u64,
    mut _8: u64,
    mut _9: isize,
    mut _10: u64,
...
pub fn main() {
    fn0(
        ...
        std::hint::black_box('\u{8e4f}'),
        std::hint::black_box((-121_isize)),
        std::hint::black_box((-36_i8)),
        std::hint::black_box((-27133_i16)),
        std::hint::black_box((-800266828_i32)),
        std::hint::black_box((-6454885325066692894_i64)),
        std::hint::black_box((-127834718574731707000918699746939557023_i128)),
        std::hint::black_box(10722309146459583091_usize),
        std::hint::black_box(247_u8),
        std::hint::black_box(41495_u16),
        std::hint::black_box(1799075644_u32),
        std::hint::black_box(3428779245612304747_u64),
        std::hint::black_box(87082945816580105533032789951923873855_u128),
    );
}
impl PrintFDebug for Adt41 {
    unsafe fn printf_debug(&self) {
        unsafe { printf(c"Adt41::".as_ptr()) };
        match self {
            Self::Variant0 { fld0 } => {
