...
pub fn main() {
    ...
    fn1();
    fn16(
        [-28, 9223372036854775807, 9223372036854775807, -9223372036854775808, 85, 9223372036854775807],
        [-28, 9223372036854775807, 9223372036854775807, -9223372036854775808, 85, 9223372036854775807],
        [-28, 9223372036854775807, 9223372036854775807, -9223372036854775808, 85, 9223372036854775807],
        '\u{4a457}', 
...
#[custom_mir(dialect = "runtime", phase = "initial")]
pub fn fn16(mut _1: [isize; 6],mut _2: [isize; 6],mut _3: [isize; 6],mut _4: char,mut _5: [usize; 3],mut _6: [usize; 3],mut _7: f32,mut _8: char,mut _9: [isize; 6],mut _10: (f32,),mut _11: [isize; 6],mut _12: [isize; 6],mut _13: [isize; 6],mut _14: [isize; 6],mut _15: [isize; 6],mut _16: [isize; 6]) -> u16 {
mir! {
type RET = u16;
let _17: isize;
