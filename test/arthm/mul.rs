...
fn main() {
    ...
    // Test overflows
    //test_eq!(black_box(255_u8).wrapping_mul(1_u8), 0_u8);
    //test_eq!(black_box(127_i8).wrapping_mul(1_i8),-128_i8);
    //test_eq!(black_box(65_535u16).wrapping_mul(1_u16), 0_u16);
    //test_eq!(black_box(32_767i16).wrapping_mul(1_i16),-32_768i16);
