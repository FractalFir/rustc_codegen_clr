use core::ptr;
type Marshal = crate::intrinsics::RustcCLRInteropManagedClass<"System.Runtime.InteropServices","System.Runtime.InteropServices.Marshal">;
pub struct Vec<T> {
    buf: *mut T,
    cap: usize,
    len: usize,
...
impl<T> Vec<T>{
    ...
    unsafe fn resize_buff_to(&mut self,new_cap:usize){
        ...
        self.buf = Marshal::static2::<"ReAllocHGlobal",usize,usize,usize>(self.buf as usize,new_cap_in_bytes) as *mut T;
        self.cap = new_cap;
    }
