        ...
        StatementKind::Intrinsic(non_diverging_intirinsic) => {
            match non_diverging_intirinsic.as_ref() {
                ...
                NonDivergingIntrinsic::CopyNonOverlapping(CopyNonOverlapping {
                    ...
                    let dst_op =
                        crate::operand::handle_operand(dst, tyctx, method, method_instance);
                    let src_op =
                        crate::operand::handle_operand(src, tyctx, method, method_instance);
                    let count_op =
                        crate::operand::handle_operand(count, tyctx, method, method_instance);
